import struct
"""
File provided by course instructor
"""
...
class packet():
    ...
    def __init__(self):
        ...
        self.RTT_flag = False
        self.buffer = None
        self.packet_incl_len = 0

    def timestamp_set(self, buffer1, buffer2, orig_time, endianness):
        seconds = struct.unpack(endianness + 'I', buffer1)[0]
        microseconds = struct.unpack(endianness + 'I', buffer2)[0]
    ...
    def incl_len_set(self, buffer, endianness):
        self.packet_incl_len = struct.unpack(endianness + "I", buffer)[0]
